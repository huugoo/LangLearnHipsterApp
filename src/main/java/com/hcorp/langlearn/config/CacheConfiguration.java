package com.hcorp.langlearn.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.hcorp.langlearn.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.hcorp.langlearn.repository.UserRepository.USERS_BY_EMAIL_CACHE);
