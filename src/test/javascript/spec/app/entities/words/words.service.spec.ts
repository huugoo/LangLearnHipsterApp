...
describe('Service Tests', () => {
  describe('Words Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Words(0, 'AAAAAAA', 'AAAAAAA');
    });
